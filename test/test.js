...
describe('Account service', function() {
    ...
    describe('Alice Debit account', function() {
      it('Calling the alice debit account - positive', function(done) {
        container
          .get('/debit')
    ...
    describe('Alice credit account', function() {
        it('Calling the alice credit account - positive', function(done) {
          container
            .get('/credit')
            .set("x-access-token",alice_token)
            .expect(200, done)
      ...
      describe('John Debit account', function() {
        it('Calling the john debit account - positive', function(done) {
          container
            .get('/debit')
      ...
      describe('john credit account', function() {
          it('Calling the john credit account - positive', function(done) {
            container
              .get('/credit')
              .set("x-access-token",john_token)
              .expect(200, done)
